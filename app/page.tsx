    ...
    <main className="app-shell">
      ...
      <section className="content">
        ...
        <div className="page-wrap">
          {view === "Overview" && <Overview totals={totals} period={period} setPeriod={setPeriod} transactions={transactions} onAdd={() => setShowModal(true)} onNavigate={nav} notify={notify} />}
...
function Overview({ totals, period, setPeriod, transactions, onAdd, onNavigate, notify }: { totals: { income: number; expense: number }; period: string; setPeriod: (value: string) => void; transactions: Transaction[]; onAdd: () => void; onNavigate: (view: View) => void; notify: (message: string) => void }) {
